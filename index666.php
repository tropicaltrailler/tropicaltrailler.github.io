            ...
            <div class="container main-menu">
                <div class="row align-items-center justify-content-between d-flex">
                  ...
                  <nav id="nav-menu-container">
                    <ul class="nav-menu">
                      <li class="menu-active"><a href="index">Início</a></li>
            ...
            <div class="container">
                <div class="row fullscreen d-flex align-items-center justify-content-center">
                    <div class="banner-content col-lg-12 col-md-12">
                        ...
                        <p class="text-white">
                            Serviço de serralheria em Contagem, Betim, Belo Horizonte e região: telhados, trailers, portões, janelas, estruturas metálicas, food-truck etc.
                        </p>
                ...
                <div class="row">
                    <div class="col-lg-4">	
                        <div class="single-cat d-flex flex-column">
                            ...
                            <h4 class="mb-20" style="margin-top: 23px;">Manutenção em serralheria e estruturas</h4>
                            <p>
                    ...
                    <div class="col-lg-4">	
                        <div class="single-cat">
                            ...
                            <h4 class="mt-40 mb-20">Serviços residenciais de serralheria</h4>
                            <p>
                    ...
                    <div class="col-lg-4">
                        <div class="single-cat">
                            ...
                            <h4 class="mt-40 mb-20">Serviços Comerciais em trailers</h4>
                            <p>
    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-8 col-md-12 home-about-left">
                <h6>Conheça nossos serviços, atendemos em Contagem, Betim, Belo Horizonte e região</h6>
                <h1>
                    Encontre os melhores produtos e serviços<br>
                    em estruturas metálicas e serralheria
                </h1>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <a href="img/pp3.jpg" class="img-gal">
                            <img class="img-fluid single-project" src="img/portaoGaragem.jpeg" alt="">
                            
                        </a>	
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <a href="img/pp4.jpg" class="img-gal">
                            <img class="img-fluid single-project" src="img/tet.jpeg" alt="">
                        </a>	
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <a href="img/pp13.jpeg" class="img-gal">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <a href="img/pp10.jpg" class="img-gal">
                            
                        </a>
                        <a href="img/pp9.jpeg" class="img-gal">
                            
                        </a>		
                        <a href="img/pp11.jpeg" class="img-gal">
                            
                        </a>
                        <a href="img/pp12.jpeg" class="img-gal">
                        ...
                        <a href="img/pp16.jpg" class="img-gal">
